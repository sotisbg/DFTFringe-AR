...
public:
    ...
    // Obstruction as a fraction of the CLEAR aperture, which is what the
    // annular Zernike basis needs.  m_annularObsPercent is a fraction of the
    // full diameter, so the two differ whenever Reduce aperture is on.
    double annularObsPercentClear() const;
